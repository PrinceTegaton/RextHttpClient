...
public class RextHttpClient : IRextHttpClient, IDisposable
{
    ...
    public virtual async Task<CustomHttpResponse<T>> PostForm<T>(RextOptions options, bool isUrlEncoded = false)
    {
    ...
    /// <param name="isUrlEncoded">Set to true to send as application/x-www-form-urlencoded</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> PostForm<T>(string url, object payload = null, object header = null, bool isUrlEncoded = false)
    {
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> PostXML<T>(RextOptions options)
    {
        options.Method = HttpMethod.Post;
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> PostXML<T>(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest<T>(new RextOptions
        {
            Url = url,
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<string>> PostXMLForString(string url, object payload = null, object header = null)
    {
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<string>> PostXMLForString(RextOptions options)
    {
        options.Method = HttpMethod.Post;
        options.ContentType = ContentType.Application_XML;
        options.ExpectedResponseFormat = ContentType.Application_XML;
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> PostJSON<T>(RextOptions options)
    {
        options.Method = HttpMethod.Post;
        options.ExpectedResponseFormat = ContentType.Application_JSON;
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> PostJSON<T>(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest<T>(new RextOptions
        {
            Url = url,
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<string>> PostJSONForString(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest(new RextOptions
        {
            Url = url,
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<string>> PostJSONForString(RextOptions options)
    {
        options.Method = HttpMethod.Post;
    ...
    public virtual async Task<CustomHttpResponse<string>> PostString(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest(new RextOptions
        {
            Url = url,
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Plain string response</returns>
    public virtual async Task<CustomHttpResponse<string>> PostString(RextOptions options)
    {
        options.Method = HttpMethod.Post;
    ...
    public virtual async Task<CustomHttpResponse<string>> GetString(RextOptions options)
    {
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>String response</returns>
    public virtual async Task<CustomHttpResponse<string>> GetString(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest(new RextOptions
        {
            Url = url,
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> GetXML<T>(RextOptions options)
    {
        options.Method = HttpMethod.Get;
        options.ExpectedResponseFormat = ContentType.Application_XML;
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> GetXML<T>(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest<T>(new RextOptions
        {
            Url = url,
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> GetJSON<T>(RextOptions options)
    {
        options.Method = HttpMethod.Get;
        options.ExpectedResponseFormat = ContentType.Application_JSON;
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> GetJSON<T>(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest<T>(new RextOptions
        {
            Url = url,
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<string>> Delete(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest(new RextOptions
        {
            Url = url,
    ...
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> DeleteJSON<T>(RextOptions options)
    {
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> DeleteJSON<T>(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest<T>(new RextOptions
        {
            Url = url,
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> PutJSON<T>(RextOptions options)
    {
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> PutJSON<T>(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest<T>(new RextOptions
        {
            Url = url,
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<string>> PutJSONForString(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest(new RextOptions
        {
            Url = url,
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<string>> PutJSONForString(RextOptions options)
    {
        options.Method = HttpMethod.Put;
        options.ContentType = ContentType.Application_JSON;
        options.ExpectedResponseFormat = ContentType.Text_Plain;
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> PatchJSON<T>(RextOptions options)
    {
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> PatchJSON<T>(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest<T>(new RextOptions
        {
            Url = url,
    ...
    /// <param name="header">Set a default header for every http call via IDictionary of strings, IList of string or key-value object (new { Authorization = "xxxx" }</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<string>> PatchJSONForString(string url, object payload = null, object header = null)
    {
        var data = await MakeRequest(new RextOptions
        {
            Url = url,
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<string>> PatchJSONForString(RextOptions options)
    {
        options.Method = HttpMethod.Put;
        options.ContentType = ContentType.Application_JSON;
        options.ExpectedResponseFormat = ContentType.Text_Plain;
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<string>> MakeRequest(RextOptions options)
    {
    ...
    /// <param name="options">RextOption to configure http call</param>
    /// <returns>Deserialized response of T</returns>
    public virtual async Task<CustomHttpResponse<T>> MakeRequest<T>(RextOptions options)
    {
        var rsp = await ProcessRequest(options);
